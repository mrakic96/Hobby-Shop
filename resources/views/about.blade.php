    ...
    <div class="container py-5">
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6"><i class="fa fa-leaf fa-2x mb-3 text-primary"></i>
          <h2 class="font-weight-light">Vizija projekta</h2>
          <p class="font-italic text-muted mb-4">Pored github repozitorija, naš projekt ima i viziju koju možete preuzeti klikom na gumb ispod.</p><a href="{{ asset('download/vizija.docx') }}" download class="btn btn-light px-5 rounded-pill shadow-sm">Preuzmite</a>
        </div>
      </div>
    </div>
  </div>
